		            ...
		            <div class="tracking-list">
		               <c:forEach items="${transaction}" var="tr">
			               ...
			               <div style="padding-top:15px;" class="inline">
				               <c:if test = "${tr.edit}">
				               		<a href="<c:url value='/edit-expense-${tr.expense_id}' />" class="btn btn-success custom-width">Edit</a>
				               		<a href="<c:url value='/delete-expense-${tr.expense_id}' />" class="btn btn-danger custom-width" >Delete</a>
				               </c:if>
		                    </div>
		                    <hr>
		              	</c:forEach>
